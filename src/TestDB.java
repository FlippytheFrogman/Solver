...
public class TestDB {
    ...
    public static void main(String[] args) {
        ...
        DataSource dataSource = setupDataSource(new Props().getDbUrl()); // args[0]);
        ...
        try {
            ...
            rset = stmt.executeQuery("select * from words where name like 'ap%'");
    ...
    public static DataSource setupDataSource(String connectURI) {
        ...
        ds.setUsername(property.getDbUserName());
        ds.setPassword(property.getDbPassword());
        ds.setInitialSize(100);

        int i = ds.getInitialSize();
        
        //ds.setDriverClassName("com.mysql.jdbc.jdbc2.optional.MysqlConnectionPoolDataSource");// ("com.mysql.jdbc.Driver");
